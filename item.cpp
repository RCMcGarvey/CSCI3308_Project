...
void populateItems() {
    ...
    ItemPool[10] = new Item(10,spell, "Inferno", false, 30, 0, 0.0, 0, "Hgh damage fireball");
    ...
    ItemPool[23] = new Item(23,consumable, "Potion of Mega Healing", true, 0, 0, 0.0, 50);
    ItemPool[24] = new Item(24,consumable, "Potion of Iron Skin", true, 0, 5, 0.0, 0);
    ItemPool[25] = new Item(25,consumable, "Potion of the Beserker", true, 5, 0, 0.0, 0);
    ItemPool[26] = new Item(26,consumable, "", true, 0, 0, 0.0, 0);
    ItemPool[27] = new Item(27,consumable, "Fireball", true, 0, 0, 0.0, 0);
    ItemPool[28] = new Item(28,spell, "Fireball", false, 0, 0, 0.0, 0);
    ItemPool[29] = new Item(29,spell, "Fireball", false, 0, 0, 0.0, 0);
}
