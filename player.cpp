...
//Accepts an npc of type 'enemy', sets player.in_combat to true. Returns -1 if already in combat
//Use methods Player::attack() and Player::adjustHealth() here?
int Player::combatEvent(enemy* enemy) {
